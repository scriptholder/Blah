...
local MinimizeButton = New("TextButton", {
    ...
    New("ImageLabel", {
        Image = (Button_Icon ~= "" and Button_Icon) or "rbxassetid://111720145628",
        BackgroundTransparency = 1,
        Size = UDim2.new(0, 0, 0, 0), -- will auto fit
    }, {
        New("UISizeConstraint", {
            MaxSize = game:GetService("ContentProvider"):GetImageSize((Button_Icon ~= "" and Button_Icon) or "rbxassetid://111720145628")
        })
    })
})
